...
## Модели (OpenRouter, дешёвые платные)

- `openai/gpt-4.1-nano` (~$0.10 / $0.40 за 1M токенов)
- `google/gemini-2.5-flash-lite` (~$0.10 / $0.40)
- `anthropic/claude-3-haiku` (~$0.25 / $1.25)

> Бесплатные `:free`-модели не годятся: тариф без купленных кредитов ограничен
> ~50 запросами/день, а прогону нужно ~880 вызовов. Дешёвые платные модели не имеют
> этого лимита, проходят полный прогон за пару минут и стоят центы (<$0.1).
